...
def all_winter_holiday_supplies(holiday_hash)
  ...
  new_array = []
  new_array << holiday_hash[:winter][:christmas][0]
  new_array << holiday_hash[:winter][:christmas][1]
  new_array << holiday_hash[:winter][:new_years][0]
  return new_array
end
...
def all_holidays_with_bbq(holiday_hash)
  ...
  holiday_hash.each do |season, holiday|
    value = holiday_hash.dig(season, holiday)
    array = []
    if value == "BBQ"
      array << ":#{holiday}"
    end
